...
let funfacts = [
    "SomeBoringNerd hates javascript A LOT, but made me with that exact language. Ain't that weird ?",
    ...
    "The image host that SomeBoringNerd is stolen from Inteliboi/ShareX-Custom-Upload and the edited version they use is available on their github.",
    "The name \"Through The Dark\" come from the One Trick Game Jam game SBN made, and it was a platerformer game. They finished last in all but one category, where she was first. \"Use of Theme\". The game have since been deleted for this one",
    ...
    "My favorites musics are the parodys from Al Yankovik",
    ...
    "I run on SomeBoringNerd's personal computer, and should be moved on a server once they buy one (they'll also put the website on it)",
    ...
    "When they write lore, SomeBoringNerd write it in french and for 30 minutes at most",
    "Water and glass use the same texture with different shader settings",
    ...
    "Despite what SomeBoringNerd said about breaking the legs of anyone who crash me, it's a joke, they won't do it (I hope)",
